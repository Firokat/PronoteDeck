...
def ac_orleans_tours(username, password):
    ...
    # ENT / PRONOTE required URLs
    #! You need to modify the 1st url to match your school !
    ent_login_page = "https://ent.netocentre.fr/cas/login?service=https://EXAMPLE.index-education.net/pronote/eleve.html&idpId=parentEleveEN-IdP"
